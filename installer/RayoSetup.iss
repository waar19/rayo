...
[Run]
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\install-powertoys-plugin.ps1"" -PluginZipPath ""{app}\RayoPlugin.zip"" -WindowsBundleZipPath ""{app}\rayo-windows.zip"" -AutoInstallDependencies $true -RestartPowerToys $true"; Flags: runhidden waituntilterminated postinstall skipifsilent
